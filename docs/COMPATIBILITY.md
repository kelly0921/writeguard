...
| Operating systems | Windows 11 local evaluation baseline; Ubuntu and Windows CI definition | Canonical evaluation passed locally on Windows; remote Ubuntu/Windows CI remains unclaimed until the workflow executes successfully |
