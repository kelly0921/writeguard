...
WriteGuard pilot support is best-effort and limited to the 0.3.x pilot baseline, unreleased 0.4.x–0.6.x Build Week lines, optional analyzer and generator 0.1.x lines, supplied PostgreSQL migrations, starter workflow, fake-provider sandbox, generated templates, and documented Stripe test-mode path. There is no uptime, response-time, data-recovery, compatibility, model-quality, or production SLA.
