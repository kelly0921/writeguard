...
WriteGuard pilot support is best-effort and limited to the 0.3.x pilot baseline, unreleased 0.4.x Build Week line, supplied PostgreSQL migrations, starter workflow, fake-provider sandbox, public templates, and documented Stripe test-mode path. There is no uptime, response-time, data-recovery, compatibility, or production SLA.
